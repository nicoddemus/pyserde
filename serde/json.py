...
def to_json(obj: Any, c: Optional[Type[Any]] = None, se: Type[Serializer] = JsonSerializer, **opts) -> str:
    """
    ...
    """
    return se.serialize(to_dict(obj, c=c, reuse_instances=False, convert_sets=True), **opts)
